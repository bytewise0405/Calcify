...
import get_computed_style from "../../../../assets/styles/legal/privacy_policy";
    ...
    >
      ...
      <View style={styles.policy}>
        ...
        <Text style={styles.policy_content}>
          ...
          Application refers to Calcify, the software program provided by the
          Company. Company (referred to as either "the Company", "We", "Us" or
          "Our" in this Agreement) refers to Calcify. Country refers to:
